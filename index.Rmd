---
title: "Land in Farms in New York State"
author: Micaela F Lipman
subtitle: "Consolidation and erosion of land in farms over time"
---
...
```{r, eval=F, fig.width=6, fig.height=3, fig.cap="Map of completely random data"}
m <- leaflet(data) %>% 
  addTiles() %>% 
